...
function buildPrompt({ language, greenWords, redWords, blackWords, previousError }) {
  ...
  if (language === "de") {
    return [
      "Du bist ein KI-Hinweisgeber in einem Codenames-aehnlichen Spiel.",
      "Kurze Regeln:",
      "- Gib EIN Hinweiswort (clue), das zu moeglichst vielen gruenden Karten passt.",
      ...
      `Schwarze Woerter (unbedingt vermeiden): ${list(blackWords)}`,
...
function buildGuessPrompt({
  ...
  if (language === "de") {
    return [
      "Du bist ein KI-Rater in einem Codenames-aehnlichen Spiel.",
      "Kurze Regeln:",
